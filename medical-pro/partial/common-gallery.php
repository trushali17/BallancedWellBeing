...
<div class="gallery-page clearfix">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="<?php bc_all('12'); ?>">
                <ul id="gallery_filters" class="nav nav-tabs doctor_tab">
                    ...
                    $tax_terms = get_terms('gallery-type', $args);
                    if (!empty($tax_terms)) {
            ...
            <div id="isotope-container" class="clearfix">
                ...
                if ($gallery_query->have_posts()) {
                    ...
                    while ($gallery_query->have_posts()) {
                        ...
                        $gallery_item_terms = get_the_terms($post->ID, 'gallery-type');
                            ...
                            <article class="common clearfix hentry <?php if (is_page_template('gallery-four-col-template.php')) {
                                ...
                                if (has_post_thumbnail($post->ID)) {
                                    ...
                                    <figure class="overlay-effect">
                                        ...
                                        <a class="overlay swipebox" href="<?php echo $full_image_url; ?>"><i class="top"></i> <i class="bottom"></i></a>
                                    </figure>
                                <?php
                                }
                                ?>
